...
import ru.kvb74.semod.opengroup.archimate.relationship.dependency.{Access, Influence, Serving}
...
import ru.kvb74.semod.opengroup.archimate.relationship.structural.{Aggregation, Assignment, Composition, Realization}
